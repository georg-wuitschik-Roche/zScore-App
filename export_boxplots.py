...
def export_paper_boxplots(output_root: Path) -> None:
    ...
    plots = [
        ...
        {
            "name": "suzuki_miyaura_solvent_base_catalyst_ArX_ArB",
            "title": "Suzuki-Miyaura - Aryl Halides + Aryl Boronates",
            "description": "z-score by solvent/base/catalyst combinations for aryl halides reacting with aryl boronates",
            "reaction_type": "Suzuki-Miyaura",
            "category": ["Solvent", "Base", "Catalyst"],
            "fg_a": ["ArBr", "ArCl", "ArI"],
            "fg_b": ["ArB(OR)2", "ArB(OH)2", "ArBF3K"],
            "max_components": 10,
        },
